...
<div class="col-12">
    <div class="mb-4 pt-3">
        <div class="row">
            <div class="col-12">
                <h5 class="fw-medium text-uppercase mb-0">Create New Referral</h5>
                <p class="fs-12">Create New Referral</p>
            </div>
        </div>
        {{ html()->form('POST')->route('eds.referral.save')->class('')->open() }}
        <div class="row g-lg-12 g-3">
            <div class="control-group col-md-3">
                <label class="form-label req">First Name </label>
                {{ html()->text('first_name', old('first_name'))->class('form-control')->placeholder('First Name')->required() }}
                @error('first_name')
            ...
            <div class="control-group col-md-3">
                ...
                {{ html()->text('last_name', old('last_name'))->class('form-control')->placeholder('Last Name')->required() }}
                @error('last_name')
            ...
            <div class="control-group col-md-3">
                ...
                {{ html()->select('course_id', $courses, NULL)->class('form-control')->required() }}
                @error('course_id')
            ...
            <div class="control-group col-md-2">
                ...
                {{ html()->date('registration_date', old('registration_date'))->class('form-control')->required() }}
